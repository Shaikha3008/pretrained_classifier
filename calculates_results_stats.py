...
def calculates_results_stats(results_dic):
  ...
  #check the matches and count up if true
...
#count up number of dog imgs     
        if results_dic[key][3] == 1:
            results_stats_dic['n_dogs_img'] += 1  
 #check correct dog idfs          
        if results_dic[key][4] == 1:
            results_stats_dic['n_correct_dogs'] += 1   
            
        # if none of the above then it is NOT DOGS!
        else:
    ...
    results_stats_dic['pct_correct_breed'] = (results_stats_dic['n_correct_breed']/results_stats_dic['n_dogs_img'])*100
     #not dog images should be the differene between all the images and the number of dog images
